...
switch PhaseName    
    ...
    case 'Hab-RewardSize'  % Habituation
       ...
       case 'Train3C'  % training
        ...
        trialsMatrix=[...
        % 1.type, 2.proba, 3.cue, 4.delay,    5.valve,                6.Outcome         	7.Marker
            1,   0.05,       1,    S.GUI.Delay,  S.GUI.RewardValve,      S.SmallRew,         double('o');...   
            2,   0.30,       1,    S.GUI.Delay,  S.GUI.RewardValve,      S.SmallRew,         double('o');...   
            3,   0.05,       1,    S.GUI.Delay,  S.GUI.RewardValve,      S.SmallRew,         double('o');...   
            4,   0.05,       2,    S.GUI.Delay,  S.GUI.RewardValve,      S.LargeRew,         double('d');...   
            5,   0.30,       2,    S.GUI.Delay,  S.GUI.RewardValve,      S.LargeRew,         double('d');...     
            6,   0.05,       2,    S.GUI.Delay,  S.GUI.RewardValve, 	 S.LargeRew,         double('d');... 
        ...
        trialsMatrix=[...
        % 1.type, 2.proba, 3.cue, 4.delay,    5.valve,                6.Outcome         	7.Marker
            1,   0.36,      1,    S.GUI.Delay,  S.GUI.RewardValve,      S.SmallRew,         double('o');...   
            2,   0.02,      1,    S.GUI.Delay,  S.GUI.RewardValve, 	    S.LargeRew,         double('d');...   
            3,   0.02,      1,    S.GUI.Delay,  S.GUI.OmissionValve, 	S.InterRew,         double('s');...   
            4,   0.36,      2,    S.GUI.Delay,  S.GUI.RewardValve, 	    S.LargeRew,         double('d');...   
            5,   0.02,      2,    S.GUI.Delay,  S.GUI.RewardValve, 	    S.SmallRew,         double('o');...   
            6,   0.02,      2,    S.GUI.Delay,  S.GUI.OmissionValve, 	S.InterRew,         double('o');...   
            7,   0.18,      3,    S.GUI.Delay,  S.GUI.OmissionValve,	S.InterRew,         double('s');...
            8,   0.02,      3,    S.GUI.Delay,  S.GUI.RewardValve,	    S.InterRew,         double('o')];   
